...
BizDevOps 研发协作 Plugin for Claude Code。

基于 [BizDevOps（必致）白皮书 2022](https://mp.weixin.qq.com/s/bizdevops) 的概念模型，为 Claude Code 提供价值驱动的人机研发协作机制。
...
| 命令 | 用途 |
|------|------|
| `/pace-init` | 初始化项目的 `bizdevops/` 状态目录 |
...
- **Claude 自治为主**：技术闭环自主推进，关键门禁等待人类审批
