...
专项：/pace-release（发布编排：create/deploy/verify/close/full/status + 空参引导 | 专家：changelog/version/tag/notes/branch/rollback） · /pace-test（测试验证：accept/strategy/coverage/impact/report | 深度：generate/flaky/dryrun/baseline） · /pace-feedback · /pace-role · /pace-theory · /pace-trace
